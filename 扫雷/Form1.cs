...
namespace WindowsFormsApp2
{
    public partial class MainWin : Form
    {
        ...
        public MainWin(int newBombNumber = 10, int newLength = 10)
        {
            //地雷数量
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            endTime = 0;
            clickNumber = 0;
            this.Text = "踩地雷(大小:" + length + ",炸彈數量:" + bombNumber + ")";
        ...
        public void GameWin()
        {
            ...
            YouWin__ fp = new YouWin__(length, bombNumber, endTime - startTime);
            fp.Owner = this;
            this.Hide();
            fp.ShowDialog();
        ...
        {
            this.Hide();   //先隐藏主窗体
            MainWin form1 = new MainWin(newBombNumber, newLength); //重新实例化此窗体
        ...
        private void boom_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //此时主窗体禁止修改
            this.Hide();
            BS fp = new BS();
        ...
        private void Rank_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Rank fp = new Rank();
            this.Hide();
            fp.Owner = this;
        ...
        private void MapScale_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //此时主窗体禁止修改
            this.Hide();
            MapSize fp = new MapSize();
            fp.Owner = this;
            fp.ShowDialog();
        }
    }
